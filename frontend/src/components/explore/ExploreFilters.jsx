...
/**
 * Clean filter UI with glassmorphism
  ...
  return (
    <div className="sticky top-24">
      <GlassCard className="p-4">
        ...
        <Accordion.Root type="multiple" defaultValue={['genres']} className="space-y-4">
          {/* Media Type */}
        ...
        {activeFiltersCount > 0 && (
          <button
            ...
            className="w-full px-3 py-2 text-xs bg-zinc-800 hover:bg-zinc-700 text-white font-semibold transition-colors mt-4"
          >
            Clear All
          </button>
        )}
