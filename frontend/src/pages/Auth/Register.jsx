...
const Register = () => {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Join the community of cinephiles"
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          <Label.Root className="text-[10px] uppercase font-bold tracking-wider text-zinc-500 ml-1">Username</Label.Root>
        ...
        <div className="space-y-1.5">
          <Label.Root className="text-[10px] uppercase font-bold tracking-wider text-zinc-500 ml-1">Password</Label.Root>
          <div className="relative group">
            <div className="absolute inset-y-0 left-3 flex items-center pointer-events-none text-zinc-500 group-focus-within:text-white transition-colors">
        ...
        <div className="space-y-1.5">
          <Label.Root className="text-[10px] uppercase font-bold tracking-wider text-zinc-500 ml-1">Confirm Password</Label.Root>
          <div className="relative group">
            <div className="absolute inset-y-0 left-3 flex items-center pointer-events-none text-zinc-500 group-focus-within:text-white transition-colors">
              <Lock className="h-4 w-4" />
            </div>
